module.exports = function toReadable (number) {
  ...
  let numTenthReading = ['ten', 'tventy', 'thirty', 'fourty', 'fifty', 'sixty', 'seventy', 'eighty', 'ninety'];
  ...
  if (number < 1000) {
    return `${numReading[Math.floor(number/100)]} hundred ${numTenthReading[(Math.floor(number/10) % 10)]} ${numReading[(number % 10)]}`
  }
